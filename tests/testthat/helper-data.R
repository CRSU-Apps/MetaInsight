...
# loaded_data_con_cov <- setup_load(file.path(test_data_dir, "Cont_long_continuous_cov.csv"), "Continuous")
# defined_data_con_cov <- setup_configure(loaded_data_con_cov$data, loaded_data_con_cov$treatment_df, "Continuous", "MD", "the_Great")
...
# fitted_covariate_model <- covariate_model(defined_data_con_cov$main_connected_data, loaded_data_con_cov$treatment_df, "Continuous", "MD", 99, "random", "shared", "the_Great")

...
excluded_data_con <- summary_exclude(defined_data_con$non_covariate_data_all, defined_data_con$treatment_df, "Placebo", "Continuous", "MD", "random", c("Study01", "Study02", "Study03", "Study04"))

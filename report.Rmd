...
```{r}
make_Forest(params$bayes, params$metaoutcome, params$axis_bayes$bayesmin, params$axis_bayes$bayesmax)
```

**Forest plot with studies excluded**

```{r}
make_Forest(params$bayes_sub, params$metaoutcome, params$axis_bayes$bayesmin_sub, params$axis_bayes$bayesmax_sub)
```

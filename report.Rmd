...
<!-- **Outcome measure**    -->
<!-- Mean difference or standardised mean difference for continuous data   -->
<!-- Odds ratio, risk ratio or risk difference for binary data -->
...
<!-- ```{r} -->
<!-- params$netGraphStatic -->
<!-- ``` -->

<!-- Network plot with studies excluded -->

<!-- ```{r} -->
<!-- params$netGraphUpdating -->
<!-- ``` -->

                                                                                                       ...
                                                                                                       box(title="Ranking panel for all studies", status='primary', solidHeader=TRUE, width=12, collapsible=TRUE,
                                                                                                           splitLayout(cellWidths=c("30%","40%","30%"), cellArgs = list(style="height: 600px; padding: 12px; border: 2px solid gold; white-space: normal"),
                                                                                                                       ...
                                                                                                                       fluidRow(align = "center", h4("Ranking Results"), 
                                                                                                                                ...
                                                                                                                                conditionalPanel(condition="input.rank_plot_choice==1", withSpinner(plotOutput("Radial"), type=6),
                                                                                                           ...
                                                                                                           splitLayout(cellWidths=c("30%","40%","30%"), cellArgs = list(style="height: 600px; padding: 12px; border: 2px solid gold; white-space: normal"),
                                                                                                                       ...
                                                                                                                       fluidRow(align = "center", h4("Ranking Results"), 
                                                                                                                                ...
                                                                                                                                conditionalPanel(condition="input.rank_plot_choice_sub==0", withSpinner(plotOutput("Litmus_sub"), type=6),
                                                                                                                                  p("Litmus Rank-O-Gram: Higher SUCRA values and cumulative probability curves nearer the top left indicate better performance")),
                                                                                                                                conditionalPanel(condition="input.rank_plot_choice_sub==1", withSpinner(plotOutput("Radial_sub"), type=6),
                                                                                                                                  p("Radial SUCRA plot: Higher SUCRA values indicate better treatments; size of nodes represent number of patients and thickness of lines indicate number of trials conducted"))),

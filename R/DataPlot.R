...
#' Adapted from BUGSnet::data.plot https://rdrr.io/github/audrey-b/BUGSnet/src/R/data.plot.R
#' 
...
#' @param covariate.label A string indicating the label of the patient characteristic to be displayed

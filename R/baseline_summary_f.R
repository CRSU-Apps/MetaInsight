...
#' @import ggplot2
#' @export
baseline_summary_old <- function(configured_data, logger = NULL){
  ...
  plot <- plot +
    labs(caption = PasteCaptionText_old("baseline risk", error_bar_text))
...
PasteCaptionText_old <- function(caption_setting, error_bar_text = NULL) {

...
tagList(
  page_navbar(
    ...
    nav_menu("Meta-regression",
             HTML('<a href="#" class="action-button btn" onclick="Shiny.setInputValue(\'tabs\', \'covariate\')">Covariate</a>'),
             HTML('<a href="#" class="action-button btn" onclick="Shiny.setInputValue(\'tabs\', \'baseline\')">Baseline risk</a>')),

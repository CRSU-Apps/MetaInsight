...
if ({{bayes_ranking_rank_style}} == "radial"){
  bayes_ranking_rank_all <- RadialSUCRA(bayes_ranking_all, !{{bayes_ranking_simple}}, {{bayes_ranking_colourblind}})
} else {
  bayes_ranking_rank_all <- LitmusRankOGram(bayes_ranking_all, {{bayes_ranking_colourblind}})
}

HTML(bayes_ranking_rank_all$svg)
```
...
HTML(bayes_ranking_network_all$svg)
```
...
HTML(bayes_ranking_forest_sub$svg)
```
...
```{r, echo = {{bayes_ranking_knit}}, include = {{bayes_ranking_knit}}}
if ({{bayes_ranking_rank_style}} == "radial"){
  bayes_ranking_rank_sub- RadialSUCRA(bayes_ranking_sub, !{{bayes_ranking_simple}}, {{bayes_ranking_colourblind}})
} else {
  bayes_ranking_rank_sub <- LitmusRankOGram(bayes_ranking_sub, {{bayes_ranking_colourblind}})
}

HTML(bayes_ranking_rank_sub$svg)
```
...
HTML(bayes_ranking_network_sub$svg)

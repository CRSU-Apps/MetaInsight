...
```{asis, echo = {{bayes_ranking_knit}}, eval = {{bayes_ranking_knit}}, include = {{bayes_ranking_knit}}}
{r, fig.width = {{bayes_ranking_forest_width_all}}, fig.height = {{bayes_ranking_forest_height_all}}}
```
```{r, echo = {{bayes_ranking_knit}}, include = {{bayes_ranking_knit}}}
...
```{asis, echo = {{bayes_ranking_knit}}, eval = {{bayes_ranking_knit}}, include = {{bayes_ranking_knit}}}
{r, fig.width = {{bayes_ranking_forest_width_sub}}, fig.height = {{bayes_ranking_forest_height_sub}}}
```
```{r, echo = {{bayes_ranking_knit}}, include = {{bayes_ranking_knit}}}

...
```
```{r, echo = {{bayes_ranking_knit}}, include = {{bayes_ranking_knit}}}
bayes_forest(bayes_model_all, treatment_df, reference_treatment_all, ranking = TRUE)
```
...
```
```{r, echo = {{bayes_ranking_knit}}, include = {{bayes_ranking_knit}}}
bayes_forest(bayes_model_sub, treatment_df_sub, reference_treatment_sub, ranking = TRUE)
```

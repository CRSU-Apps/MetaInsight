...
```{asis, echo = {{bayes_forest_knit}}, eval = {{bayes_forest_knit}}, include = {{bayes_forest_knit}}}
{r, fig.width = {{bayes_forest_plot_width_all}}, fig.height = {{bayes_forest_plot_height_all}}}
```
...
```{asis, echo = {{bayes_forest_knit}}, eval = {{bayes_forest_knit}}, include = {{bayes_forest_knit}}}
{r, fig.width = {{bayes_forest_plot_width_sub}}, fig.height = {{bayes_forest_plot_height_sub}}}
```
```{r, echo = {{bayes_forest_knit}}, include = {{bayes_forest_knit}}}

...
bayes_nodesplit_all <- bayes_nodesplit(main_connected_data, treatment_df, outcome, outcome_measure, model_type)
bayes_nodesplit_sub <- bayes_nodesplit(connected_data_sub, treatment_df_sub, outcome, outcome_measure, model_type)
```

```{asis, echo = {{bayes_nodesplit_knit}}, eval = {{bayes_nodesplit_knit}}, include = {{bayes_nodesplit_knit}}}
{r, fig.align='center', fig.width = 8, fig.height = {{bayes_nodesplit_plot_height_all}}}
```
```{r, echo = {{bayes_nodesplit_knit}}, include = {{bayes_nodesplit_knit}}}
...
```{asis, echo = {{bayes_nodesplit_knit}}, eval = {{bayes_nodesplit_knit}}, include = {{bayes_nodesplit_knit}}}
{r, fig.align='center', fig.width = 8, fig.height = {{bayes_nodesplit_plot_height_sub}}}
```
```{r, echo = {{bayes_nodesplit_knit}}, include = {{bayes_nodesplit_knit}}}

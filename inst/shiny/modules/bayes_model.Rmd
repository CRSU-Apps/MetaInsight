...
bayes_model_all <- bayes_model(main_connected_data, treatment_df, outcome, outcome_measure, model_type, reference_treatment_all, seed)
bayes_model_sub <- bayes_model(connected_data_sub, treatment_df_sub, outcome, outcome_measure, model_type, reference_treatment_sub, seed)
```

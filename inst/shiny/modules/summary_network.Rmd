...
summary_network(frequentist_all, bugsnet_all, network_style, {{summary_network_label_all}}, "Network plot of all studies")
```
...
```
```{r, echo = {{summary_network_knit}}, include = {{summary_network_knit}}}
summary_network(frequentist_sub, bugsnet_sub, network_style, {{summary_network_label_sub}}, "Network plot with selected \n studies excluded")
```

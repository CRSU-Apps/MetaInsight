...
- The app is now available as a package on CRAN and can be installed using `install.packages("metainsight")` and then opened using `library(metainsight)` and `run_metainsight()`

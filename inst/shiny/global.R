...
mirai::daemons(1, sync = TRUE) # add sync = TRUE for debugging
...
base_module_configs <- c(
  ...
  "modules/setup_configure.yml",
  "modules/setup_reload.yml",
  "modules/setup_upgrade.yml",
  "modules/setup_exclude.yml",
...
# source core modules
core_modules <- file.path("modules", list.files(system.file("shiny", "modules", package="metainsight"), pattern="core_*"))
